...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6 top-margin">
     <div class="row"> 
      <div class="col-md-5">
        <img src="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/images/kcr-1.jpg" class="img-responsive" alt="name">
      </div>
      <div class="col-md-7 padding-list">
        <p class="name-details">Name : <span class="name-details-1">KCR</span></p>
        <p class="name-details">Profile Type : <span class="name-details-1">MLA</span></p>
        <p class="name-details">Party : <span class="name-details-1">TRS</span></p>
        <p class="name-details">Constituency : <span class="name-details-1">Gajwel</span></p>
        <p class="name-details">District : <span class="name-details-1">Medak</span></p>
        <p class="name-details">State : <span class="name-details-1">Telangana</span></p>
