  ...
  <div class="row">
    <div class="col-md-3">
      <div class="heading-text-1">
        <img src="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/images/congress.png" class="img-responsive bjp-img" alt="">
        <h3>congress</h3>
      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                         <div class="card hovercard">
                          ...
                          <div class="avatar">
                              <img alt="" src="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/images/congress-mp.png" >
                          </div>
                          <div class="info">
                              <div class="title">
                  ...
                  <div class="col-md-6">
                    <div class="card hovercard">
                          <div class="cardheader-1"></div>
                          <div class="avatar">
                              <img alt="" src="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/images/congress-mp1.jpg">
                          </div>
                          <div class="info">
                              <div class="title">
                                  <a target="_blank" href="" class="mp-text">Nadendla Manohar</a>
                              </div>
                              <div class="desc">Telangana, MP</div>
                               <button class="btn-1">Read More</button>
                          </div>
